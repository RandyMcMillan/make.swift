...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/RandyMcMillan/myLibrary.swift.git", .branch("master")),
        //.package(url: "https://github.com/SwiftOnTheServer/CCurl.git", .branch("master"))
        .package(url: "git@github.com:Kitura/CCurl.git", .branch("master"))
        //.package(url: "CCurl/.git", .branch("master")),
    ],
    targets: [
